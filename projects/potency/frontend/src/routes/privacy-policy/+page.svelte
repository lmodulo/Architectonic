...
<svelte:head>
  <title>Privacy Policy — Potency By Potamus</title>
  <meta name="description" content="Privacy policy for Potency By Potamus." />
</svelte:head>
...
<div class="page-wrap">
  ...
  <section class="section">
    <div class="section-inner">
      ...
      <h2 class="section-heading">Privacy Notice</h2>

      <p class="body-text">
        This privacy notice discloses the privacy practices for potencybypotamus.com. This privacy
        notice applies solely to information collected by this website. It will notify you of the
        following:
      </p>

      <ol class="body-list body-list--ordered">
      ...
      <h3 class="policy-heading">Information Collection, Use, and Sharing</h3>
      ...
      <h3 class="policy-heading">Your Access to and Control Over Information</h3>
      ...
      <h3 class="policy-heading">Security</h3>
      ...
      <p class="body-text">
        ...
        immediately via telephone at <a href="tel:5099875588">509-987-5588</a> or via email at
        <a href="mailto:potencybypotamus@gmail.com">potencybypotamus@gmail.com</a>.
      </p>

      <h3 class="policy-heading">Registration</h3>
      ...
      <h3 class="policy-heading">Orders</h3>
      ...
      <h3 class="policy-heading">Cookies</h3>
      ...
      <p class="body-text">
        ...
        and target the interests of our users to enhance the experience on our site. Usage of a
      ...
      <h3 class="policy-heading">Sharing</h3>
      ...
      <p class="body-text">
        We use an outside shipping company to ship orders, and a credit card processing company to
      ...
      <p class="body-text">
        ...
        services, we will share names, or other contact information that is necessary for the third
        party to provide these services. These parties are not allowed to use personally identifiable
        information except for the purpose of providing these services.
      </p>

      <h3 class="policy-heading">Links</h3>
