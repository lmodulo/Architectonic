...
<svelte:head>
  <title>Shipping &amp; Return Policy — Potency By Potamus</title>
  <meta name="description" content="Shipping and return policy for Potency By Potamus." />
</svelte:head>
