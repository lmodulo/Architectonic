...
describe('GET /notifications', () => {
  ...
  beforeAll(async () => {
    ...
    ({ userId } = await createUser(getDb(), { username: 'notifuser', email: 'notif@t.com', password: 'pw123456', role: 'owner' }));
...
describe('GET /notifications/unread-count', () => {
  ...
  beforeAll(async () => {
    ...
    await seedRoles(getDb());
    await seedDefaultSettings(getDb());
    ({ userId } = await createUser(getDb(), { username: 'countuser', email: 'count@t.com', password: 'pw123456', role: 'owner' }));
...
describe('GET /notifications/preferences + PUT /notifications/preferences', () => {
  ...
  beforeAll(async () => {
    ...
    await seedRoles(getDb());
    await seedDefaultSettings(getDb());
    ({ userId } = await createUser(getDb(), { username: 'prefsuser', email: 'prefs@t.com', password: 'pw123456', role: 'owner' }));
