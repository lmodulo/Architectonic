// Shared aggregation pipeline for agile_milestones with rollup stats.
// Joins sprints → jobs → tasks to compute effort and completion, and
// looks up crm_companies to resolve clientName.
