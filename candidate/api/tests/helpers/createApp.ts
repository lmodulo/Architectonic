...
import automationPlugin from '../../src/plugins/automation.js';
...
import automationRoutes    from '../../src/routes/automation/index.js';
...
import workspacesRoutes    from '../../src/routes/workspaces/index.js';
import teamsRoutes         from '../../src/routes/teams/index.js';

export async function createTestApp(mongoUri: string) {
  // Session and MongoDB plugins read these env vars at registration time
  ...
  // Register routes with the same URL prefixes @fastify/autoload would use
