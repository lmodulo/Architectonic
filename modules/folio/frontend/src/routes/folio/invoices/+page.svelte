<script lang="ts">
  import { ChevronDown, ChevronUp, ChevronsUpDown, FileText, Plus, Trash2, X } from 'lucide-svelte';
...
<div class="space-y-6">
  ...
  {#if invoices.length === 0}
    <div class="card bg-base-200 border border-base-300 rounded-box p-8 text-center">
      <FileText size={32} class="size-8 opacity-20 mx-auto mb-2" />
      ...
      <div class="space-y-2">
        ...
        <div class="flex items-center justify-between pt-1">
          <button type="button" class="btn btn-ghost btn-sm" onclick={addLine}>
            <Plus size={16} class="size-4" /> Add line
          </button>
