<script lang="ts">
  import { CheckCircle, ChevronLeft, ChevronRight, ClipboardList, XCircle } from 'lucide-svelte';
...
<div class="p-6 max-w-5xl mx-auto">
  <div class="flex items-center gap-3 mb-6">
    <ClipboardList size={24} class="w-6 h-6 opacity-60" />
    <div>
  ...
  {#if estimates.length === 0}
    <div class="text-center py-16 opacity-40">
      <ClipboardList size={40} class="w-10 h-10 mx-auto mb-3" />
              ...
              <td>
                {#if est.status === 'sent'}
                  <div class="flex gap-1 justify-end">
                    ...
                    >
                      <CheckCircle size={12} class="w-3 h-3" /> Accept
                    </button>
                    <button
                    ...
                    >
                      <XCircle size={12} class="w-3 h-3" /> Decline
                    </button>
                  </div>
                {/if}
              </td>
