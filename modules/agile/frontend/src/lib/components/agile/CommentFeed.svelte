<script lang="ts">
  import { Check, MessageSquare, Pencil, Send, Trash2, X } from 'lucide-svelte';
...
<div class="space-y-4">
  ...
  {:else if comments.length === 0}
    <div class="flex flex-col items-center gap-1 py-6 opacity-35">
      <MessageSquare size={20} class="size-5" />
