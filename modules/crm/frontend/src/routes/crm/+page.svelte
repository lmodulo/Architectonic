<script lang="ts">
  import { Building2, Calendar, DollarSign, TrendingUp } from 'lucide-svelte';
...
<div class="space-y-8">
  ...
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
    ...
    <div class="card bg-base-200 border border-base-300 rounded-box p-4 flex items-start gap-3">
      <div class="p-2 rounded-lg bg-success/15"><DollarSign size={16} class="size-4 text-success"/></div>
      <div>
    ...
    <div class="card bg-base-200 border border-base-300 rounded-box p-4 flex items-start gap-3">
      <div class="p-2 rounded-lg bg-accent/15"><Calendar size={16} class="size-4 text-accent"/></div>
      <div>
    ...
    <div class="card bg-base-200 border border-base-300 rounded-box p-4 flex items-start gap-3">
      <div class="p-2 rounded-lg bg-secondary/15"><Building2 size={16} class="size-4 text-secondary"/></div>
      <div>
