<script lang="ts">
  import { AlertTriangle, Check, CheckCircle, Clock, PenLine, RotateCcw, X } from 'lucide-svelte';
    ...
    <div class="w-full max-w-3xl flex flex-col gap-6">
      ...
      {#if data.state === 'not_found'}
        <div class="card bg-base-100 shadow-sm p-8 text-center flex flex-col items-center gap-4">
          <AlertTriangle size={48} class="size-12 text-error opacity-60" />
      ...
      {:else if data.state === 'expired'}
        <div class="card bg-base-100 shadow-sm p-8 text-center flex flex-col items-center gap-4">
          <Clock size={48} class="size-12 text-warning opacity-60" />
      ...
      {:else if data.state === 'already_signed'}
        <div class="card bg-base-100 shadow-sm p-8 text-center flex flex-col items-center gap-4">
          <CheckCircle size={48} class="size-12 text-success opacity-70" />
      ...
      {:else if data.state === 'declined'}
        <div class="card bg-base-100 shadow-sm p-8 text-center flex flex-col items-center gap-4">
          <X size={48} class="size-12 text-error opacity-60" />
            ...
            <div class="card bg-base-100 shadow-sm p-6 flex flex-col gap-4">
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                  <PenLine size={16} class="size-4 text-base-content/60" />
                ...
                <button
                  ...
                  title="Clear"
                >
                  <RotateCcw size={12} class="size-3" /> Clear
                </button>
              </div>
              ...
              <div class="flex items-center justify-between gap-3 pt-1">
                ...
                >
                  <X size={16} class="size-4" /> Decline to Sign
                </button>
                <button
                  type="button"
